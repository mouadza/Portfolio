...
const projects: Project[] = [
  {
    ...
    title: "Food Delivery",
    description:
      "A modern food ordering web app with real-time tracking and online payment integration.",
    demoLink: "#",
    githubLink: "#",
  },
  {
    ...
    title: "Weekend Permanence",
    description:
      "An internal scheduling platform that automates team weekend rotations.",
    demoLink: "#",
    githubLink: "#",
  },
  {
    ...
    description:
      "A full-stack hotel booking app built with Spring Boot and Angular.",
    demoLink: "#",
    githubLink: "#",
  },
];
